...
public class BusinessYearDefinitionServiceImpl implements BusinessYearDefinitionService {
	...
	public BusinessYearDefinition add(BusinessYearDefinition businessYearDefinition) {
		...
		if(logger.isDebugEnabled()) logger.debug("BusinessYearDefinition saved into DB: "+businessYearDefinition);
	...
	private void validate(BusinessYearDefinition businessYearDefinition) {
		...
		BusinessYearDefinition businessYear=businessYearDefinitionRepository.findByfromDateAndToDate(businessYearDefinition.getFromDate(), businessYearDefinition.getToDate());
